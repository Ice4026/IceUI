...
local positions = {
    player_buff_icon    = { "RIGHT", UIParent, "CENTER", -120, 15 },	-- "玩家buff&debuff"
    target_buff_icon    = { "LEFT", UIParent, "CENTER", 120, 15 },	-- "目标buff&debuff"
    player_proc_icon    = { "RIGHT", UIParent, "CENTER", -120, -30 },	-- "玩家重要buff&debuff"
        ...
        ["DEMONHUNTER"] = {
            {
                ...
                -- { spellID = 227723, unitId = "player", caster = "player", filter = "BUFF" },
            },
            {
                name = "目标buff&debuff",
                direction = "RIGHT",
