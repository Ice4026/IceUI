...
function TukuiUnitFrames:Player()
	...
	Health.Value:Point("TOPRIGHT", Health, "TOPRIGHT", -4, -2)
	...
	Power.Value:Point("BOTTOMRIGHT", Health, "BOTTOMRIGHT", -4, 2)
	...
	AdditionalPower.Prediction:SetWidth(250)
	...
	Name:Point("LEFT", Health, "LEFT", 8, 0)
