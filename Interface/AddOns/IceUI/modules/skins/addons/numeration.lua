...
local function SkinNumeration()
	...
	Numeration.windowsettings.linetexture = IC.Medias.Textures.normal
	Numeration.windowsettings.linefont = IC.Medias.Textures.font
	Numeration.windowsettings.titlefont = IC.Medias.Textures.font
	Numeration.windowsettings.linefontsize = IC.Medias.Textures.fontsize
...
Skins:RegisterSkin("Numeration", SkinNumeration)
