...
local function SkinBigWigs()
	...
	local applystyle = function(bar)
		...
		bar.candyBarLabel:SetFont(IC.Medias.Textures.font, 12, "OUTLINE")
		bar.candyBarLabel:SetShadowColor(0, 0, 0, 0)
		bar.candyBarLabel:SetJustifyH("LEFT")
		bar.candyBarLabel:ClearAllPoints()
		bar.candyBarLabel:Point("LEFT", bar, "LEFT", 4, 0)

		bar.candyBarDuration:SetFont(IC.Medias.Textures.font, 12, "OUTLINE")
		...
		bar.candyBarBar:SetStatusBarTexture(IC.Medias.Textures.normal)
		bar.candyBarBackground:SetTexture(unpack(IC.Medias.Textures.backdropcolor))
...
Skins:RegisterSkin("BigWigs", SkinBigWigs)