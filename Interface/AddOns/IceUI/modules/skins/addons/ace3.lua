...
local function SkinAce3()
	...
	AceGUI.RegisterAsWidget = function(self, widget)
		...
		if TYPE == "MultiLineEditBox" then
			...
			Skins:Reskin(widget.button)
			Skins:ReskinScroll(widget.scrollBar)
		elseif TYPE == "CheckBox" then
			widget.checkbg:Kill()
			widget.highlight:Kill()
			widget.frame:SetHighlightTexture(IC.Medias.Textures.gloss)
			...
			if not widget.skinnedCheckBG then
				...
				Skins:CreateBD(widget.skinnedCheckBG, 0)
				Skins:CreateBackdropTexture(widget.skinnedCheckBG)
			end
		...
		elseif TYPE == "Dropdown" then
			...
			button:SetDisabledTexture(IC.Medias.Textures.gloss)
			...
			button:HookScript('OnClick', function(this)
				local self = this.obj
				Skins:CreateBD(self.pullout.frame)
			end)
		elseif TYPE == "LSM30_Font" or TYPE == "LSM30_Sound" or TYPE == "LSM30_Border" or TYPE == "LSM30_Background" or TYPE == "LSM30_Statusbar" then
			...
			if not frame.backdrop then
				...
				Skins:CreateBackdropTexture(frame.backdrop)
				Skins:CreateBD(frame.backdrop)
	...
	AceGUI.RegisterAsContainer = function(self, widget)
		...
		elseif TYPE == "InlineGroup" or TYPE == "TreeGroup" or TYPE == "TabGroup" or TYPE == "SimpleGroup" or TYPE == "Frame" or TYPE == "DropdownGroup" then
			...
			if widget.treeframe then
				...
				-- Skins:CreateBD(widget.treeframe, .3)
...
Skins:RegisterSkin("RayUI", SkinAce3)
