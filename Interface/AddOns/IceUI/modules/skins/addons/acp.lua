...
local function SkinACP()
	...
	local function ReskinDropDown(f)
		...
		down:SetDisabledTexture(IC.Medias.Textures.gloss)
	...
	ACP_AddonList:SetScript("OnShow", function(self)
		...
		Skins:Reskin(ACP_AddonListSetButton)
		Skins:Reskin(ACP_AddonListDisableAll)
		Skins:Reskin(ACP_AddonListEnableAll)
		Skins:Reskin(ACP_AddonList_ReloadUI)
		Skins:Reskin(ACP_AddonListBottomClose)
		Skins:ReskinClose(ACP_AddonListCloseButton)
		...
		Skins:ReskinScroll(ACP_AddonList_ScrollFrameScrollBar)
	end)
end

Skins:RegisterSkin("ACP", SkinACP)