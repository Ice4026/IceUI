...
local function SkinAtlasLoot()
	...
	local function AL_OnShow(self, event, ...)
		...
		local AL = ""
			...
			Skins:ReskinClose(AtlasLootDefaultFrame_LockButton)
	end
	...
	SkinAL:SetScript("OnEvent", function(self, event, addon)
		...
		local buttons = {
					...
					for _, object in pairs(SetTemplateT) do
								Skins:CreateBD(_G[object])
								Skins:CreateSD(_G[object])
					end

		-- Skin Buttons
					for _, button in pairs(buttons) do
									Skins:Reskin(_G[button])
					end
		...
		-- Skin Close Buttons
			Skins:ReskinClose(AtlasLootDefaultFrame_CloseButton)
			Skins:ReskinClose(AtlasLootDefaultFrame_LockButton)
			Skins:ReskinClose(AtlasLootCompareFrame_CloseButton)
			Skins:ReskinClose( AtlasLootCompareFrame_CloseButton_Wishlist)

		-- Skin Next Previous Buttons
			Skins:ReskinArrow(AtlasLootQuickLooksButton, "right")
			Skins:ReskinArrow(AtlasLootItemsFrame_NEXT, "right")
			Skins:ReskinArrow(AtlasLootItemsFrame_PREV, "left")
			Skins:ReskinArrow(AtlasLootPanelSearch_SelectModuel, "right")
			Skins:ReskinArrow(AtlasLootCompareFrameSearch_SelectModuel, "right")

		-- Skin Dropdown Boxes
			Skins:ReskinDropDown(AtlasLootDefaultFrame_ModuleSelect, 225)
			Skins:ReskinDropDown(AtlasLootDefaultFrame_InstanceSelect, 225)
			Skins:ReskinDropDown(AtlasLootCompareFrameSearch_StatsListDropDown,240)
			Skins:ReskinDropDown(AtlasLootCompareFrame_WishlistDropDown,200)

		-- Skin Edit Boxes
			Skins:ReskinInput(AtlasLootPanelSearch_Box)
			Skins:ReskinInput(AtlasLootCompareFrameSearch_Box)

		-- Skin Check Boxes
			Skins:ReskinCheck(AtlasLootFilterCheck)
			Skins:ReskinCheck(AtlasLootItemsFrame_Heroic)
			Skins:ReskinCheck(AtlasLootCompareFrameSearch_FilterCheck)
...
-- Skins:RegisterSkin("AtlasLoot", SkinAtlasLoot)