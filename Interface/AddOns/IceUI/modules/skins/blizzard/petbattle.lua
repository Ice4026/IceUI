...
local function LoadSkin()
	...
	for index, infoBar in pairs(infoBars) do
		...
		infoBar.ActualHealthBar:SetTexture(IC.Medias.Textures.normal)
		...
		infoBar.PetTypeFrame.text:SetFont(IC.Medias.Textures.font, IC.Medias.Textures.fontsize, "OUTLINE")
		...
		infoBar.Name:SetFont(IC.Medias.Textures.font, IC.Medias.Textures.fontsize, "OUTLINE")
	...
	hooksecurefunc("PetBattleAuraHolder_Update", function(self)
		...
		for i=1, C_PetBattles.GetNumAuras(self.petOwner, self.petIndex) do
			...
			if (isBuff and self.displayBuffs) or (not isBuff and self.displayDebuffs) then
				...
				frame.Duration:SetFont(IC.Medias.Textures.font, IC.Medias.Textures.fontsize, "OUTLINE")
	...
	local function SkinPetTooltip(tt)
		...
		if tt.ActualHealthBar then
			tt.ActualHealthBar:SetTexture(IC.Medias.Textures.normal)
		end
		if tt.XPBar then
			tt.XPBar:SetTexture(IC.Medias.Textures.normal)
		end
		...
		tt.border:SetBackdropBorderColor(unpack(IC.Medias.Textures.bordercolor))
		tt.shadow:SetBackdropBorderColor(unpack(IC.Medias.Textures.bordercolor))
	end
	...
	Skins:Reskin(bf.TurnTimer.SkipButton)
	...
	bf.xpBar:SetScript("OnShow", function(self) self:StripTextures() self:SetStatusBarTexture(IC.Medias.Textures.normal) end)
