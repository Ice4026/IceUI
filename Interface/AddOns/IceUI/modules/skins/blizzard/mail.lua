...
local function LoadSkin()
	Skins:ReskinPortraitFrame(MailFrame, true)
	Skins:ReskinPortraitFrame(OpenMailFrame, true)
	...
	Skins:ReskinClose(MailFrameCloseButton)
	...
	for i = 1, 2 do
		Skins:CreateTab(_G["MailFrameTab"..i])
	end
	...
	Skins:ReskinArrow(InboxPrevPageButton, "left")
	Skins:ReskinArrow(InboxNextPageButton, "right")
	Skins:ReskinScroll(SendMailScrollFrameScrollBar)
	Skins:ReskinScroll(OpenMailScrollFrameScrollBar)
