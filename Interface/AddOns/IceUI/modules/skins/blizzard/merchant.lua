...
local function LoadSkin()
	Skins:ReskinPortraitFrame(MerchantFrame, true)
	...
	Skins:ReskinClose(MerchantFrameCloseButton)
	Skins:ReskinDropDown(MerchantFrameLootFilter)

	Skins:ReskinArrow(MerchantPrevPageButton, "left")
	Skins:ReskinArrow(MerchantNextPageButton, "right")
	...
	Skins:CreateTab(MerchantFrameTab1)
	Skins:CreateTab(MerchantFrameTab2)
	...
	Skins:CreateBD(MerchantBuyBackItemItemButton, 0)
	Skins:CreateBD(MerchantBuyBackItem, .25)
	...
	Skins:CreateBG(MerchantGuildBankRepairButton)
	MerchantGuildBankRepairButtonIcon:SetTexCoord(0.61, 0.82, 0.1, 0.52)
	MerchantGuildBankRepairButton:StyleButton(true)

	Skins:CreateBG(MerchantRepairAllButton)
	MerchantRepairAllIcon:SetTexCoord(0.34, 0.1, 0.34, 0.535, 0.535, 0.1, 0.535, 0.535)
	MerchantRepairAllButton:StyleButton(true)

	Skins:CreateBG(MerchantRepairItemButton)
