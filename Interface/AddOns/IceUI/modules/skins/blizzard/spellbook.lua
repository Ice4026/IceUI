...
local function LoadSkin()
	Skins:SetBD(SpellBookFrame)
	Skins:ReskinArrow(SpellBookPrevPageButton, "left")
	Skins:ReskinArrow(SpellBookNextPageButton, "right")
	Skins:Reskin(SpellBookCompanionSummonButton)
	Skins:ReskinClose(SpellBookFrameCloseButton)
	...
	for i = 1, 5 do
		Skins:CreateTab(_G["SpellBookFrameTabButton"..i])
	end
	...
	for _, button in pairs(professions) do
		...
		bu.statusBar:SetStatusBarTexture(IC.Medias.Textures.gloss)
