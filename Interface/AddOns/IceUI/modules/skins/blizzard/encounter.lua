...
local function LoadSkin()
	...
	Skins:SetBD(EncounterJournal)
	Skins:CreateBD(EncounterJournalSearchResults, .75)
	...
	for _, tab in pairs(tabs) do
		...
		tab:SetBackdrop({
			bgFile = IC.Medias.Textures.gloss,
			edgeFile = IC.Medias.Textures.gloss,
			edgeSize = 1 / .75,
		})
	...
	Skins:CreateBDFrame(EncounterJournalEncounterFrameInfoModelFrame, .25)
	...
	hooksecurefunc("EncounterJournal_ToggleHeaders", function(self)
		...
		while header do
			if not header.styled then
				...
				Skins:Reskin(header.button)

				header.button.abilityIcon:SetTexCoord(.08, .92, .08, .92)
				header.button.bg = Skins:CreateBG(header.button.abilityIcon)
	...
	Skins:CreateBD(EncounterJournalTooltip)

	EncounterJournalTooltip.Item1.newBg = Skins:ReskinIcon(EncounterJournalTooltip.Item1.icon)
	EncounterJournalTooltip.Item2.newBg = Skins:ReskinIcon(EncounterJournalTooltip.Item2.icon)
	...
	Skins:CreateBD(suggestion, .25)

	suggestion.icon:SetPoint("TOPLEFT", 135, -15)
	Skins:CreateBG(suggestion.icon)
	...
	Skins:Reskin(suggestion.button)
	...
	Skins:CreateBG(reward.icon)

	Skins:ReskinArrow(suggestion.prevButton, "left")
	Skins:ReskinArrow(suggestion.nextButton, "right")
	...
	for i = 2, 3 do
		...
		Skins:Reskin(centerDisplay.button)
	...
	Skins:Reskin(EncounterJournalNavBarHomeButton)
	Skins:Reskin(EncounterJournalInstanceSelectSuggestTab)
	Skins:Reskin(EncounterJournalInstanceSelectDungeonTab)
	Skins:Reskin(EncounterJournalInstanceSelectRaidTab)
	EncounterJournalInstanceSelectLootJournalTab:StripTextures()
	Skins:Reskin(EncounterJournalInstanceSelectLootJournalTab)
	EncounterJournal.encounter.info.difficulty:StripTextures()
	Skins:Reskin(EncounterJournal.encounter.info.difficulty)
	EncounterJournal.encounter.info.reset:StripTextures()
	Skins:Reskin(EncounterJournal.encounter.info.reset)
	EncounterJournal.encounter.info.lootScroll.filter:StripTextures()
	Skins:Reskin(EncounterJournal.encounter.info.lootScroll.filter)
	EncounterJournal.LootJournal.LegendariesFrame.ClassButton:StripTextures()
	Skins:Reskin(EncounterJournal.LootJournal.LegendariesFrame.ClassButton)
	EncounterJournal.LootJournal.LegendariesFrame.SlotButton:StripTextures()
	Skins:Reskin(EncounterJournal.LootJournal.LegendariesFrame.SlotButton)
	EncounterJournal.LootJournal.ItemSetsFrame.ClassButton:StripTextures()
	Skins:Reskin(EncounterJournal.LootJournal.ItemSetsFrame.ClassButton)
	Skins:ReskinDropDown(LootJournalViewDropDown)
	Skins:ReskinScroll(EncounterJournalScrollBar)
	Skins:ReskinClose(EncounterJournalCloseButton)
	Skins:ReskinClose(EncounterJournalSearchResultsCloseButton)
	Skins:ReskinInput(EncounterJournalSearchBox)
	Skins:ReskinScroll(EncounterJournalInstanceSelectScrollFrameScrollBar)
	Skins:ReskinScroll(EncounterJournalEncounterFrameInstanceFrameLoreScrollFrameScrollBar)
	Skins:ReskinScroll(EncounterJournalEncounterFrameInfoDetailsScrollFrameScrollBar)
	Skins:ReskinScroll(EncounterJournalEncounterFrameInfoLootScrollFrameScrollBar)
	Skins:ReskinScroll(EncounterJournalEncounterFrameInfoBossesScrollFrameScrollBar)
	Skins:ReskinScroll(EncounterJournalSearchResultsScrollFrameScrollBar)
	Skins:ReskinDropDown(EncounterJournalInstanceSelectTierDropDown)
end

Skins:RegisterSkin("Blizzard_EncounterJournal", LoadSkin)
