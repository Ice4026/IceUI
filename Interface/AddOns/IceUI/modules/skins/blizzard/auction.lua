...
local function LoadSkin()
	...
	Skins:SetBD(AuctionFrame, 2, -10, 0, 10)
	Skins:CreateBD(AuctionProgressFrame)
	Skins:ReskinCheck(ExactMatchCheckButton)

	AuctionProgressBar:SetStatusBarTexture(IC.Medias.Textures.gloss)
	...
	Skins:CreateBD(ABBD, .25)

	Skins:ReskinClose(AuctionProgressFrameCancelButton, "LEFT", AuctionProgressBar, "RIGHT", 4, 0)
	...
	for i = 1, 3 do
		Skins:CreateTab(_G["AuctionFrameTab"..i])
	end
	...
	Skins:CreateBD(AuctionsItemButton, .25)
	local _, AuctionsItemButtonNameFrame = AuctionsItemButton:GetRegions()
	AuctionsItemButtonNameFrame:Hide()

	Skins:ReskinClose(AuctionFrameCloseButton, "TOPRIGHT", AuctionFrame, "TOPRIGHT", -4, -14)
	Skins:ReskinScroll(BrowseScrollFrameScrollBar)
	Skins:ReskinScroll(AuctionsScrollFrameScrollBar)
	Skins:ReskinScroll(BrowseFilterScrollFrameScrollBar)
	Skins:ReskinDropDown(PriceDropDown)
	Skins:ReskinDropDown(DurationDropDown)
	Skins:ReskinInput(BrowseName)
	Skins:ReskinArrow(BrowsePrevPageButton, "left")
	Skins:ReskinArrow(BrowseNextPageButton, "right")
	Skins:ReskinCheck(IsUsableCheckButton)
	Skins:ReskinCheck(ShowOnPlayerCheckButton)
	...
	Skins:Reskin(BrowseDropDownButton)
	...
	Skins:Reskin(BrowseWowTokenResults.Buyout)

	-- Tutorial

	local WowTokenGameTimeTutorial = WowTokenGameTimeTutorial

	Skins:ReskinPortraitFrame(WowTokenGameTimeTutorial, true)
	Skins:Reskin(StoreButton)
	...
	do
		...
		iconBorder:SetTexture(IC.Medias.Textures.gloss)
...
Skins:RegisterSkin("Blizzard_AuctionUI", LoadSkin)
