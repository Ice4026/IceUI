...
local function LoadSkin()
	...
	Skins:CreateBD(ScriptErrorsFrame)
	Skins:CreateSD(ScriptErrorsFrame)

	Skins:CreateBD(EventTraceFrame)
	Skins:CreateSD(EventTraceFrame)
	Skins:ReskinClose(EventTraceFrameCloseButton)
	...
	Skins:ReskinClose(ScriptErrorsFrameClose)
	Skins:ReskinScroll(ScriptErrorsFrameScrollFrameScrollBar)
	Skins:Reskin(select(4, ScriptErrorsFrame:GetChildren()))
	Skins:Reskin(select(5, ScriptErrorsFrame:GetChildren()))
	Skins:Reskin(select(6, ScriptErrorsFrame:GetChildren()))
...
Skins:RegisterSkin("Blizzard_DebugTools", LoadSkin)