...
local function LoadSkin()
	...
	Skins:CreateBG(PlayerTalentFrameTalentsClearInfoFrame)
	...
	for i = 1, NUM_TALENT_FRAME_TABS do
		Skins:CreateTab(_G["PlayerTalentFrameTab"..i])
	end
	...
	for _, frame in pairs({PlayerTalentFrameSpecialization, PlayerTalentFramePetSpecialization}) do
		...
		Skins:CreateBG(scrollChild.specIcon)
	end
	...
	for _, name in pairs(buttons) do
		for i = 1, 4 do
			...
			local bg = Skins:CreateBG(bu.specIcon)
	...
	Skins:ReskinPortraitFrame(PlayerTalentFrame, true)
	Skins:Reskin(PlayerTalentFrameSpecializationLearnButton)
	Skins:Reskin(PlayerTalentFrameTalentsLearnButton)
	Skins:Reskin(PlayerTalentFrameActivateButton)
	Skins:Reskin(PlayerTalentFramePetSpecializationLearnButton)
end

Skins:RegisterSkin("Blizzard_TalentUI", LoadSkin)
