...
local function LoadSkin()
	Skins:CreateBD(AchievementFrame)
	Skins:CreateSD(AchievementFrame)
	...
	Skins:ReskinInput(AchievementFrame.searchBox)
	...
	AchievementFrameSummaryCategoriesStatusBar:SetStatusBarTexture(IC.Medias.Textures.gloss)
--	AchievementFrameSummaryCategoriesStatusBar:GetStatusBarTexture():SetGradient("VERTICAL", 0, .4, 0, 0, .6, 0)
	...
	for i = 1, 7 do
		...
		bu.background:SetTexture(IC.Medias.Textures.gloss)
		...
		Skins:CreateBG(bu.icon.texture)
	end
	...
	hooksecurefunc("AchievementFrameSummary_UpdateAchievements", function()
		for i = 1, ACHIEVEMENTUI_MAX_SUMMARY_ACHIEVEMENTS do
			...
			if not bu.reskinned then
				...
				bd:SetTexture(IC.Medias.Textures.gloss)
	...
	for i = 1, 12 do
		...
		bu:SetStatusBarTexture(IC.Medias.Textures.gloss)
	...
	Skins:ReskinClose(AchievementFrameCloseButton)
	Skins:ReskinScroll(AchievementFrameAchievementsContainerScrollBar)
	Skins:ReskinScroll(AchievementFrameStatsContainerScrollBar)
	Skins:ReskinScroll(AchievementFrameCategoriesContainerScrollBar)
	Skins:ReskinScroll(AchievementFrameComparisonContainerScrollBar)
	Skins:ReskinDropDown(AchievementFrameFilterDropDown)
end

Skins:RegisterSkin("Blizzard_AchievementUI", LoadSkin)
