...
local function LoadSkin()
	...
	Skins:CreateBD(ItemUpgradeFrame.ItemButton, .25)
	...
	Skins:ReskinPortraitFrame(ItemUpgradeFrame)
	Skins:Reskin(ItemUpgradeFrameUpgradeButton)
end

Skins:RegisterSkin("Blizzard_ItemUpgradeUI", LoadSkin)
