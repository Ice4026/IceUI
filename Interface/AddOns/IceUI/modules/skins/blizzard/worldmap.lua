...
local function LoadSkin()
	...
	Skins:SetBD(BorderFrame, 1, 0, -3, 2)
	Skins:ReskinClose(BorderFrame.CloseButton)
	Skins:ReskinArrow(WorldMapFrame.UIElementsFrame.CloseQuestPanelButton, "left")
	Skins:ReskinArrow(WorldMapFrame.UIElementsFrame.OpenQuestPanelButton, "right")
	Skins:ReskinDropDown(WorldMapLevelDropDown)
	Skins:ReskinNavBar(WorldMapFrameNavBar)
