...
local function LoadSkin()
	...
	ClassTrainerStatusBar:SetStatusBarTexture(IC.Medias.Textures.gloss)
	...
	Skins:Reskin(ClassTrainerTrainButton)

	Skins:ReskinClose(ClassTrainerFrameCloseButton)
	Skins:ReskinScroll(ClassTrainerScrollFrameScrollBar)
	Skins:ReskinDropDown(ClassTrainerFrameFilterDropDown)
end

Skins:RegisterSkin("Blizzard_TrainerUI", LoadSkin)