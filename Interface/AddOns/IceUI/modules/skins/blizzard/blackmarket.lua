...
local function LoadSkin()
	...
	Skins:CreateBG(BlackMarketFrame.HotDeal.Item)
	...
	Skins:SetBD(BlackMarketFrame)
	Skins:CreateBD(BlackMarketFrame.HotDeal, .25)
	Skins:Reskin(BlackMarketFrame.BidButton)
	Skins:Reskin(BlackMarketFrame.HotDeal.BidButton)
	Skins:ReskinClose(BlackMarketFrame.CloseButton)
	Skins:ReskinInput(BlackMarketBidPriceGold)
	Skins:ReskinInput(BlackMarketHotItemBidPriceGold)
	Skins:ReskinScroll(BlackMarketScrollFrameScrollBar)
...
Skins:RegisterSkin("Blizzard_BlackMarketUI", LoadSkin)
