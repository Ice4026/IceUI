...
local function LoadSkin()
    ...
    Skins:ReskinPortraitFrame(TradeFrame, true)
	for i = 3, 6 do
		select(i, TradeFrame:GetRegions()):Hide()
	end
	Skins:Reskin(TradeFrameTradeButton)
	Skins:Reskin(TradeFrameCancelButton)
	...
	Skins:ReskinInput(TradePlayerInputMoneyFrameGold)
	Skins:ReskinInput(TradePlayerInputMoneyFrameSilver)
	...
	Skins:ReskinInput(TradePlayerInputMoneyFrameCopper)
