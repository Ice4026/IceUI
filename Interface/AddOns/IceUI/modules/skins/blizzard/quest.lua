...
local function LoadSkin()
	...
	Skins:ReskinPortraitFrame(QuestFrame, true)
	...
	for _, questButton in pairs({"QuestFrameAcceptButton", "QuestFrameDeclineButton", "QuestFrameCompleteQuestButton", "QuestFrameCompleteButton", "QuestFrameGoodbyeButton", "QuestFrameGreetingGoodbyeButton"}) do
		Skins:Reskin(_G[questButton])
	end

	Skins:ReskinScroll(QuestProgressScrollFrameScrollBar)
	Skins:ReskinScroll(QuestRewardScrollFrameScrollBar)
	Skins:ReskinScroll(QuestDetailScrollFrameScrollBar)
	Skins:ReskinScroll(QuestGreetingScrollFrameScrollBar)
	...
	Skins:ReskinScroll(QuestNPCModelTextScrollFrameScrollBar)
end
