...
local function LoadSkin()
	...
	if not(IsAddOnLoaded("Butsu") or IsAddOnLoaded("LovelyLoot") or IsAddOnLoaded("XLoot")) then
		...
		Skins:CreateBD(MasterLooterFrame)
		...
		local function CreateLootSlot(self, id)
			...
			slot.text:SetFont(IC.Medias.Textures.font, IC.Medias.Textures.fontsize, IC.Medias.Textures.fontflag)
			...
			slot.count:SetFont(IC.Medias.Textures.font, IC.Medias.Textures.fontsize, IC.Medias.Textures.fontflag)
		...
		loot.title:SetFont(IC.Medias.Textures.font, IC.Medias.Textures.fontsize, IC.Medias.Textures.fontflag)
		...
		for i = 1, #chn do
			...
			loot.announce[i]:SetBackdropBorderColor(unpack(IC.Medias.Textures.bordercolor))
