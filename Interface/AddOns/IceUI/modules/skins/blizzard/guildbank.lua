...
local function LoadSkin()
	...
	Skins:CreateBD(bd)
	Skins:CreateBD(GuildBankPopupEditBox, .25)
	...
	Skins:Reskin(GuildBankFrameWithdrawButton)
	Skins:Reskin(GuildBankFrameDepositButton)
	Skins:Reskin(GuildBankFramePurchaseButton)
	Skins:Reskin(GuildBankPopupOkayButton)
	Skins:Reskin(GuildBankPopupCancelButton)
	Skins:Reskin(GuildBankInfoSaveButton)
	Skins:ReskinClose(GuildBankFrame.CloseButton)
	Skins:ReskinInput(GuildItemSearchBox)
...
Skins:RegisterSkin("Blizzard_GuildBankUI", LoadSkin)
